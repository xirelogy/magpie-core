...
/**
 * Poll for asynchronous process events
 * @internal
 */
class ProcessAsyncPoll implements MainLoopPollable
{
    ...
    /**
     * @var array<string, ProcessAsyncHandle> Registered handles
     */
    ...
    /**
     * Register a handle
     * @param ProcessAsyncHandle $handle
     * @return void
     */
    public function registerHandle(ProcessAsyncHandle $handle) : void
    {
     ...
     * @return void
     */
    public function deregisterHandle(ProcessAsyncHandle $handle) : void
    {
