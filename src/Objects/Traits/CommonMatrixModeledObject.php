...
/**
 * Common multi-typed + feature matrix modeled object
 * @template MT
 * @requires \Magpie\Objects\ModeledObject
 */
trait CommonMatrixModeledObject
{
    /**
    ...
    protected static final function fromModel(mixed $db) : ?static
    {
        ...
        if (ClassReflection::isConcrete(static::class)) {
            ...
            $subjectTypeClass = $db->{static::getSubjectTypeClassColumnName()};

            $className = ClassFactory::resolveFeature($typeClass, $subjectTypeClass, static::getBaseClassName());
     ...
     * @return string
     */
    protected static abstract function getSubjectTypeClass() : string;
    ...
    /**
     * The column name containing the 'SubjectTypeClass' at the base model
     * @return string
     */
    protected static abstract function getSubjectTypeClassColumnName() : string;
